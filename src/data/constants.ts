...
export const EDUCATION: Education[] = [
  {
    ...
    school: "K. S. SCHOOL OF ENGINEERING & MANAGEMENT",
    description: [
      "Gaining a solid foundation in computer science and business management principles.",
      "Developing skills in software engineering, database management, and data structures.",
  ...
  },
  {
    ...
    school: "St. Claret PU College | Bengaluru, Karnataka",
    description: [
      "Studied Physics, Chemistry, Mathematics, and Electronics (PCME).",
      "Learnt basics of Arduino and electronics.",
      "Built a working voice-controlled robot that moves by responding to sound commands.",
    ],
  },
];
